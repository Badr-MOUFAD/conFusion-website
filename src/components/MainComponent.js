...
export default function Main() {
  ...
  function getFirstDishByID(name) {
  ...
  return (
    <div>
      ...
      <Switch>
        ...
        <Route path="/about-us" component={() => <h1>About us view</h1>}/>
        <Route exact path="/menu" component={({ location }) => <MenuComponent location={location} dishes={dishes}/>}/>
        <Route path="/menu/:name" component={({ match, location }) => <DishDetailComponent location={location} dish={getFirstDishByID(match.params.name)}/>}/>
